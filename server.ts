    ...
    if (contentType.includes("application/json")) {
      ...
      if (!isTextOnly) {
        ...
        if (driveUrl) {
          ...
          mimeType = detectAudioMimeType(undefined, undefined, req.body.mimeType || "");
        }
      }
    } else {
      if (!req.file) {
      ...
      mimeType = detectAudioMimeType(req.file.buffer, req.file.originalname, req.file.mimetype);
